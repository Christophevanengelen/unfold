...
const BOUDINS = [
  ...
  // NOW (boudin ends 16px above NOW line)
  { y: -80,  w: 38, h: 64,  color: "#B07CC2", opacity: 1,    dots: 4, year: 2026, isCurrent: true },
  // Past (starts 16px below NOW line)
  { y: 16,   w: 28, h: 44,  color: "#6BA89A", opacity: 0.7,  dots: 3, year: 2020 },
