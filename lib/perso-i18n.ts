...
const MOTS: Record<string, Traduction> = {
  ...
  // ── Gestion des matchs : filtre par categorie, ajout, suppression ────────
  "compat.tous":         { fr:"Tous", en:"All", es:"Todos", de:"Alle", it:"Tutti", pt:"Todos", nl:"Alle", ja:"すべて", zh:"全部", ar:"الكل" },
  "compat.filtrer_categorie": { fr:"Filtrer par type de relation", en:"Filter by relationship type", es:"Filtrar por tipo de relación", de:"Nach Beziehungsart filtern", it:"Filtra per tipo di relazione", pt:"Filtrar por tipo de relação", nl:"Filteren op relatietype", ja:"関係の種類で絞り込む", zh:"按关系类型筛选", ar:"تصفية حسب نوع العلاقة" },
  "compat.categorie_vide": { fr:"Aucune connexion dans cette catégorie", en:"No connections in this category", es:"Ninguna conexión en esta categoría", de:"Keine Verbindung in dieser Kategorie", it:"Nessuna connessione in questa categoria", pt:"Nenhuma ligação nesta categoria", nl:"Geen verbinding in deze categorie", ja:"このカテゴリーにつながりはありません", zh:"该分类下暂无连接", ar:"لا يوجد اتصال في هذه الفئة" },
  "compat.supprimer_qui": { fr:"Supprimer {n} ?", en:"Remove {n}?", es:"¿Eliminar a {n}?", de:"{n} entfernen?", it:"Eliminare {n}?", pt:"Remover {n}?", nl:"{n} verwijderen?", ja:"{n}を削除しますか？", zh:"删除{n}？", ar:"حذف {n}؟" },
  // ── Match solo : encoder soi-meme un match, sans invitation ni code (18/09) ──
  "compat.ajouter_match":      { fr:"Ajouter un match", en:"Add a match", es:"Añadir un match", de:"Match hinzufügen", it:"Aggiungi un match", pt:"Adicionar um match", nl:"Match toevoegen", ja:"マッチを追加", zh:"添加匹配", ar:"إضافة تطابق" },
  "compat.ajouter_code_titre": { fr:"Se connecter avec un code", en:"Connect with a code", es:"Conectar con un código", de:"Mit einem Code verbinden", it:"Connettersi con un codice", pt:"Ligar com um código", nl:"Verbinden met een code", ja:"コードでつながる", zh:"使用代码连接", ar:"الاتصال برمز" },
  "compat.ajouter_code_sous":  { fr:"Vous installez chacun l'app et échangez un code", en:"You each install the app and exchange a code", es:"Cada uno instala la app e intercambiáis un código", de:"Ihr installiert beide die App und tauscht einen Code aus", it:"Installate entrambi l'app e vi scambiate un codice", pt:"Cada um instala a app e trocam um código", nl:"Jullie installeren allebei de app en wisselen een code uit", ja:"それぞれアプリを入れてコードを交換します", zh:"双方各自安装应用并交换代码", ar:"يثبّت كل منكما التطبيق ويتبادلان رمزاً" },
  "compat.ajouter_manuel_titre": { fr:"Créer moi-même ce match", en:"Create this match myself", es:"Crear yo mismo este match", de:"Diesen Match selbst anlegen", it:"Creo io stesso questo match", pt:"Criar este match eu mesmo", nl:"Deze match zelf aanmaken", ja:"自分でこのマッチを作る", zh:"自己创建此匹配", ar:"إنشاء هذا التطابق بنفسي" },
  "compat.ajouter_manuel_sous": { fr:"Sans invitation : vous encodez sa naissance vous-même", en:"No invitation — you enter their birth details yourself", es:"Sin invitación: introduces tú mismo sus datos de nacimiento", de:"Ohne Einladung — du gibst die Geburtsdaten selbst ein", it:"Senza invito: inserisci tu stesso i suoi dati di nascita", pt:"Sem convite: introduzes tu os dados de nascimento", nl:"Zonder uitnodiging: jij voert de geboortegegevens zelf in", ja:"招待なし — 相手の生年月日をあなたが入力します", zh:"无需邀请——由你自己输入对方的出生信息", ar:"بلا دعوة: تُدخل بيانات ميلاده بنفسك" },
  "compat.solo_badge":         { fr:"Vu par toi seul·e", en:"Visible to you only", es:"Solo tú lo ves", de:"Nur für dich sichtbar", it:"Visibile solo a te", pt:"Visível só para ti", nl:"Alleen zichtbaar voor jou", ja:"あなただけに表示", zh:"仅你可见", ar:"مرئي لك فقط" },
  "solo.titre": { fr:"Qui voulez-vous ajouter ?", en:"Who do you want to add?", es:"¿A quién quieres añadir?", de:"Wen möchtest du hinzufügen?", it:"Chi vuoi aggiungere?", pt:"Quem queres adicionar?", nl:"Wie wil je toevoegen?", ja:"誰を追加しますか？", zh:"你想添加谁？", ar:"من تريد أن تضيف؟" },
  "solo.sous":  { fr:"Son prénom et sa naissance — comme les vôtres à l'inscription.", en:"Their first name and birth details — just like yours at sign-up.", es:"Su nombre y sus datos de nacimiento — como los tuyos al registrarte.", de:"Vorname und Geburtsdaten — wie deine eigenen bei der Anmeldung.", it:"Nome e dati di nascita — come i tuoi in fase di iscrizione.", pt:"O nome e os dados de nascimento — como os teus no registo.", nl:"Voornaam en geboortegegevens — net als die van jou bij aanmelding.", ja:"相手の名前と生年月日 — あなたが登録したときと同じです。", zh:"对方的名字和出生信息——和你注册时一样。", ar:"اسمه وبيانات ميلاده — تماماً كبياناتك عند التسجيل." },
  "solo.cta":   { fr:"Voir la compatibilité", en:"See the compatibility", es:"Ver la compatibilidad", de:"Kompatibilität ansehen", it:"Vedi la compatibilità", pt:"Ver a compatibilidade", nl:"Compatibiliteit bekijken", ja:"相性を見る", zh:"查看契合度", ar:"عرض التوافق" },
  "solo.voir_matchs": { fr:"Voir mes matchs", en:"See my matches", es:"Ver mis matches", de:"Meine Matches ansehen", it:"Vedi i miei match", pt:"Ver os meus matches", nl:"Mijn matches bekijken", ja:"自分のマッチを見る", zh:"查看我的匹配", ar:"عرض تطابقاتي" },
