...
type Strings = {
  ...
  match: {
    eyebrow: string; exemple: string; titre: string; sous: string;
    terrain: string; terrain_aide: string;
    intensite: string; intensite_aide: string;
    aisance: string; aisance_aide: string;
    communs: string; propres_toi: string; propres_autre: string;
    rythme: string;
    ecart_synchrone: string; ecart_decale: string; ecart_asymetrique: string; ecart_aucun: string;
...
const FR: Strings = {
  ...
  match: {
    ...
    exemple: "Exemple",
    titre: "Vous deux, ce mois-ci",
    sous: "Une lecture par mois, pas un verdict sur vous.",
    terrain: "Terrain commun",
    terrain_aide: "La part des sujets ouverts chez l'un ou l'autre que vous partagez ce mois-ci.",
    intensite: "Intensité",
    intensite_aide: "À quel point ce mois vous remue tous les deux.",
    aisance: "Aisance",
    aisance_aide: "À quel point il est simple. Un mois intense et peu aisé n'est pas un mois raté.",
    communs: "Ce que vous partagez",
    propres_toi: "Ce que tu portes seul",
    propres_autre: "Ce qu'elle ou il porte seul",
    rythme: "Vos rythmes",
    ecart_synchrone: "vous avancez au même pas",
    ecart_decale: "vous n'êtes pas sur le même tempo",
    ecart_asymetrique: "l'un porte beaucoup plus que l'autre",
    ecart_aucun: "rien de commun ce mois-ci",
    fort: "fort",
    moyen: "moyen",
    faible: "faible",
    pas_verdict: "Ce chiffre dit ce mois-ci, jamais si vous vous convenez.",
    domaines: {
...
const EN: Strings = {
  ...
  match: {
    ...
    exemple: "Example",
    titre: "The two of you, this month",
    sous: "One reading per month, not a verdict on you.",
    terrain: "Common ground",
    terrain_aide: "The share of topics open for either of you that you both have this month.",
    intensite: "Intensity",
    intensite_aide: "How much this month stirs you both.",
    aisance: "Ease",
    aisance_aide: "How smooth it is. An intense, uneasy month is not a failed one.",
    communs: "What you share",
    propres_toi: "What you carry alone",
    propres_autre: "What they carry alone",
    rythme: "Your rhythms",
    ecart_synchrone: "you move at the same pace",
    ecart_decale: "you're not on the same tempo",
    ecart_asymetrique: "one carries far more than the other",
    ecart_aucun: "nothing in common this month",
    fort: "high",
    moyen: "medium",
    faible: "low",
    pas_verdict: "This number is about this month, never about whether you suit each other.",
    domaines: {
...
const ES: Strings = {
  ...
  match: {
    eyebrow: "Lo que da",
    exemple: "Ejemplo",
    titre: "Ustedes dos, este mes",
    sous: "Una lectura por mes, no un veredicto sobre ustedes.",
    terrain: "Terreno común",
    terrain_aide: "La parte de los temas abiertos en uno u otro que comparten este mes.",
    intensite: "Intensidad",
    intensite_aide: "Cuánto les remueve este mes a los dos.",
    aisance: "Facilidad",
    aisance_aide: "Lo simple que es. Un mes intenso y poco fácil no es un mes fallido.",
    communs: "Lo que comparten",
    propres_toi: "Lo que llevas tú solo",
    propres_autre: "Lo que lleva él o ella solo",
    rythme: "Sus ritmos",
    ecart_synchrone: "avanzan al mismo paso",
    ecart_decale: "no van al mismo ritmo",
    ecart_asymetrique: "uno carga mucho más que el otro",
    ecart_aucun: "nada en común este mes",
    fort: "alto",
    moyen: "medio",
    faible: "bajo",
    pas_verdict: "Esta cifra habla de este mes, nunca de si se convienen.",
    domaines: {
...
const DE: Strings = {
  ...
  match: {
    ...
    exemple: "Beispiel",
    titre: "Ihr beide, diesen Monat",
    sous: "Eine Lesung pro Monat, kein Urteil über euch.",
    terrain: "Gemeinsamer Boden",
    terrain_aide: "Der Anteil der bei einem von beiden offenen Themen, den ihr diesen Monat teilt.",
    intensite: "Intensität",
    intensite_aide: "Wie sehr euch dieser Monat beide bewegt.",
    aisance: "Leichtigkeit",
    aisance_aide: "Wie einfach er ist. Ein intensiver, schwerer Monat ist kein gescheiterter.",
    communs: "Was ihr teilt",
    propres_toi: "Was du allein trägst",
    propres_autre: "Was sie oder er allein trägt",
    rythme: "Eure Rhythmen",
    ecart_synchrone: "ihr geht im selben Schritt",
    ecart_decale: "ihr seid nicht im selben Takt",
    ecart_asymetrique: "einer trägt weit mehr als der andere",
    ecart_aucun: "nichts Gemeinsames diesen Monat",
    fort: "hoch",
    moyen: "mittel",
    faible: "gering",
    pas_verdict: "Diese Zahl gilt für diesen Monat, nie dafür, ob ihr zueinander passt.",
    domaines: {
...
const IT: Strings = {
  ...
  match: {
    ...
    exemple: "Esempio",
    titre: "Voi due, questo mese",
    sous: "Una lettura al mese, non un verdetto su di voi.",
    terrain: "Terreno comune",
    terrain_aide: "La parte dei temi aperti nell'uno o nell'altro che condividete questo mese.",
    intensite: "Intensità",
    intensite_aide: "Quanto questo mese vi scuote entrambi.",
    aisance: "Scorrevolezza",
    aisance_aide: "Quanto è semplice. Un mese intenso e poco scorrevole non è un mese fallito.",
    communs: "Ciò che condividete",
    propres_toi: "Ciò che porti da solo",
    propres_autre: "Ciò che porta da solo",
    rythme: "I vostri ritmi",
    ecart_synchrone: "andate allo stesso passo",
    ecart_decale: "non siete sullo stesso tempo",
    ecart_asymetrique: "uno porta molto più dell'altro",
    ecart_aucun: "niente in comune questo mese",
    fort: "alto",
    moyen: "medio",
    faible: "basso",
    pas_verdict: "Questa cifra parla di questo mese, mai del fatto che vi conveniate.",
    domaines: {
...
const PT: Strings = {
  ...
  match: {
    ...
    exemple: "Exemplo",
    titre: "Vocês os dois, este mês",
    sous: "Uma leitura por mês, não um veredicto sobre vocês.",
    terrain: "Terreno comum",
    terrain_aide: "A parte dos temas abertos num ou noutro que partilham este mês.",
    intensite: "Intensidade",
    intensite_aide: "O quanto este mês vos abala aos dois.",
    aisance: "Facilidade",
    aisance_aide: "O quão simples é. Um mês intenso e pouco fácil não é um mês falhado.",
    communs: "O que partilham",
    propres_toi: "O que carregas sozinho",
    propres_autre: "O que ele ou ela carrega sozinho",
    rythme: "Os vossos ritmos",
    ecart_synchrone: "avançam ao mesmo passo",
    ecart_decale: "não estão no mesmo tempo",
    ecart_asymetrique: "um carrega muito mais do que o outro",
    ecart_aucun: "nada em comum este mês",
    fort: "alto",
    moyen: "médio",
    faible: "baixo",
    pas_verdict: "Este número fala deste mês, nunca de se vocês se convêm.",
    domaines: {
...
const NL: Strings = {
  ...
  match: {
    ...
    exemple: "Voorbeeld",
    titre: "Jullie twee, deze maand",
    sous: "Eén lezing per maand, geen oordeel over jullie.",
    terrain: "Gemeenschappelijke grond",
    terrain_aide: "Het deel van de bij een van beiden open thema's dat jullie deze maand delen.",
    intensite: "Intensiteit",
    intensite_aide: "Hoezeer deze maand jullie beiden raakt.",
    aisance: "Gemak",
    aisance_aide: "Hoe soepel het gaat. Een intense, stroeve maand is geen mislukte maand.",
    communs: "Wat jullie delen",
    propres_toi: "Wat jij alleen draagt",
    propres_autre: "Wat hij of zij alleen draagt",
    rythme: "Jullie ritmes",
    ecart_synchrone: "jullie lopen in hetzelfde tempo",
    ecart_decale: "jullie zitten niet op hetzelfde tempo",
    ecart_asymetrique: "de een draagt veel meer dan de ander",
    ecart_aucun: "niets gemeenschappelijks deze maand",
    fort: "hoog",
    moyen: "gemiddeld",
    faible: "laag",
    pas_verdict: "Dit getal gaat over deze maand, nooit over of jullie bij elkaar passen.",
    domaines: {
...
const JA: Strings = {
  ...
  match: {
    ...
    exemple: "例",
    titre: "二人の今月",
    sous: "月ごとの読み取りであって、二人への判定ではありません。",
    terrain: "重なっている領域",
    terrain_aide: "どちらかで開いている話題のうち、今月二人が共有している割合。",
    intensite: "強さ",
    intensite_aide: "今月が二人をどれだけ揺さぶるか。",
    aisance: "なめらかさ",
    aisance_aide: "どれだけ楽か。強くて楽でない月は、失敗した月ではありません。",
    communs: "共有していること",
    propres_toi: "あなたが一人で抱えること",
    propres_autre: "相手が一人で抱えること",
    rythme: "二人のテンポ",
    ecart_synchrone: "同じ歩幅で進んでいます",
    ecart_decale: "テンポが合っていません",
    ecart_asymetrique: "片方の負荷がずっと大きい",
    ecart_aucun: "今月は重なりがありません",
    fort: "高い",
    moyen: "中くらい",
    faible: "低い",
    pas_verdict: "この数字は今月のこと。相性の良し悪しではありません。",
    domaines: {
...
const ZH: Strings = {
  ...
  match: {
    ...
    exemple: "示例",
    titre: "你们俩，本月",
    sous: "每月一次的解读，而不是对你们的判决。",
    terrain: "共同领域",
    terrain_aide: "本月你们共同拥有的、在任一方开启的话题所占比例。",
    intensite: "强度",
    intensite_aide: "本月对你们两人的触动有多大。",
    aisance: "顺畅度",
    aisance_aide: "有多轻松。强烈而不轻松的一个月，并不是失败的一个月。",
    communs: "你们共有的",
    propres_toi: "你独自承担的",
    propres_autre: "对方独自承担的",
    rythme: "你们的节奏",
    ecart_synchrone: "你们步调一致",
    ecart_decale: "你们节奏不同",
    ecart_asymetrique: "一方承担得多得多",
    ecart_aucun: "本月没有交集",
    fort: "高",
    moyen: "中",
    faible: "低",
    pas_verdict: "这个数字说的是本月，绝不是你们是否合适。",
    domaines: {
...
const AR: Strings = {
  ...
  match: {
    eyebrow: "هكذا تبدو",
    exemple: "مثال",
    titre: "أنتما الاثنان، هذا الشهر",
    sous: "قراءة لكل شهر، لا حُكم عليكما.",
    terrain: "الأرض المشتركة",
    terrain_aide: "نسبة الموضوعات المفتوحة عند أحدكما والتي تتشاركانها هذا الشهر.",
    intensite: "الشدّة",
    intensite_aide: "كم يهزّكما هذا الشهر معاً.",
    aisance: "اليُسر",
    aisance_aide: "كم هو سهل. شهر شديد وغير يسير ليس شهراً فاشلاً.",
    communs: "ما تتشاركانه",
    propres_toi: "ما تحمله وحدك",
    propres_autre: "ما يحمله الآخر وحده",
    rythme: "إيقاعاكما",
    ecart_synchrone: "تسيران بالخطوة نفسها",
    ecart_decale: "لستما على الإيقاع نفسه",
    ecart_asymetrique: "أحدكما يحمل أكثر بكثير",
    ecart_aucun: "لا شيء مشترك هذا الشهر",
    fort: "مرتفع",
    moyen: "متوسط",
    faible: "منخفض",
    pas_verdict: "هذا الرقم يخصّ هذا الشهر، لا ما إذا كنتما مناسبين لبعضكما.",
    domaines: {
