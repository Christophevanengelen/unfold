...
const ES: Strings = {
  ...
  resume: {
    ...
    branche_tache_titre: "La semilla — una mancha de tinta",
    branche_tache_expl: "Tinta diluida que el papel se bebe: se abre un periodo, aún sin forma.",
    branche_fleur_titre: "La floración — una flor",
...
const PT: Strings = {
  ...
  resume: {
    ...
    branche_tache_titre: "A semente — uma mancha de tinta",
    branche_tache_expl: "Tinta diluída absorvida pelo papel: abre-se um período, ainda sem forma.",
    branche_fleur_titre: "A floração — uma flor",
...
const JA: Strings = {
  ...
  resume: {
    ...
    branche_tache_titre: "種 — 墨のにじみ",
    branche_tache_expl: "薄めた墨が紙に染みていく。ひとつの時期が開き、まだ形はない。",
    branche_fleur_titre: "開花 — 一輪の花",
...
const ZH: Strings = {
  ...
  resume: {
    ...
    branche_tache_titre: "种子 — 一处墨痕",
    branche_tache_expl: "淡墨渗入纸中：一段时期开启，尚无形状。",
    branche_fleur_titre: "花开 — 一朵花",
...
const AR: Strings = {
  ...
  resume: {
    ...
    branche_tache_titre: "البذرة — لطخة حبر",
    branche_tache_expl: "حبر مخفّف يتسرّب في الورق: فترة تنفتح، بلا شكل بعد.",
    branche_fleur_titre: "التفتّح — زهرة",
